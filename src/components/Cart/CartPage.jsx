...
const CartPage = () => {
          ...
          <div className="flex-1">
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <input
                      ...
                      onChange={() =>
                        dispatch(toggleProductSelection(item.product.id))
                      }
            ...
            <div className="mt-10 text-right border-t pt-6">
              <h2 className="text-lg font-semibold text-slate-800">
                Seçilen Ürünlerin Toplamı: ${selectedTotal.toFixed(2)}
              </h2>
            </div>
          </div>
  ...
  <OrderSummaryBox
    productTotal={Number(selectedTotal.toFixed(2))}
    shippingPrice={29.99}
